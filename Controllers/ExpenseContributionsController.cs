...
namespace GroupExpenseManagement01.Controllers
{
    ...
    public class ExpenseContributionsController : Controller
    {
        ...
        public IActionResult ExportToExcel(String GroupIDString)
        {
            ...
            //Stream stream = ExpenseRepository.SelectByPkWithCurrencyName("PR_ExpenseContributions_SelectByGroup", GroupID, "GroupID");
            Stream stream = CommonClass.ExportToExcel2("PR_ExpenseContributions_SelectByGroup", GroupID, "GroupID");
        ...
        public IActionResult ExportToExcelSettlement(String GroupIDString)
        {
            ...
            Stream stream = CommonClass.ExportToExcel2("PR_Settlements_SelectByGroupPK", GroupID, "GroupID");
